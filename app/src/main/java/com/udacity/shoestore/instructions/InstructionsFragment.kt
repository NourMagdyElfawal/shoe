...
class InstructionsFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        binding.buttonGoToShoeList.setOnClickListener { v: View ->
            v.findNavController().navigate(InstructionsFragmentDirections.actionInstructionsFragmentToShowListFragment())
        }
